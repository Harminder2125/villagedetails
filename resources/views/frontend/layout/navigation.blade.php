                  ...
                  <nav class="bg-zinc-900 opacity-90 border-gray-200 px-2 sm:px-4 py-0.5 dark:bg-gray-900">
                    <div class="container flex flex-wrap items-center justify-between mx-auto">
                      ...
                      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        ...
                        <li>
                            <a href="/" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent {{ Route::is('home') ? 'md:text-orange-400' : '' }} md:hover:text-orange-400 md:p-0 dark:text-white" >Introduction</a>
                          </li>
                        <li>
                            <a href="/panchayat" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded {{ Route::is('panchayat') ? 'md:text-orange-400' : '' }} md:bg-transparent md:p-0 dark:text-white" aria-current="page">Panchayat</a>
                          </li>
                          <li>
