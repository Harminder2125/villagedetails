...
<div class="flex">
  <div class="basis-3/4 pr-5">
    ...
    <div class="bg-zinc-100 flex rounded p-2 mb-5">
      ...
      <h6 class="text-sm ml-1 font-normal text-orange-500">Important details related to village Fatehabad</h6>
    </div>
  ...
  <div class="basis-1/4 pl-1 2xl:pl-5">
    <div class="flex flex-col items-center justify-center mt-9 ">
      <img class=" w-40 h-44 2xl:h-48 2xl:w-48 rounded" src="./assets/images/MLA/drkashmirsingh.jpg"/>
    ...
    <div class="h-48 flex flex-col items-center justify-center mt-9  rounded py-3">
